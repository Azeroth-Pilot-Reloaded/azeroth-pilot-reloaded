if APR.Faction == "Alliance" then
    APR.RouteQuestStepList["DF01A-84-Stormwind"] = {
        ...
        {
            Qpart = { [66589] = { 3 } },
            Coord = { y = -8805.9, x = 622.4 },
            Range = 2,
            ExtraLineText = "RECRUIT_SCHOLARS",
            Gossip = 1
        },
        { Qpart = { [72240] = { 1 } }, Coord = { y = -8776.5, x = 838.6 },  Range = 2,   Gossip = 1 },
        {
            Qpart = { [66589] = { 2 } },
            Coord = { y = -8521.4, x = 1058.5 },
            Range = 2,
            ExtraLineText = "RECRUIT_EXPLORERS",
            Gossip = 1
        },
        { Done = { 66589 },            Coord = { y = -8640.6, x = 1328.2 } },
        { Done = { 72240 },            Coord = { y = -8640.6, x = 1328.2 } },
