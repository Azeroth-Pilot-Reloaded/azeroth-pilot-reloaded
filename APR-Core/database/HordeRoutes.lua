if (APR.Faction == "Horde") then
    APR.RouteList.Vanilla = {
        ...
        ["21-Silverpine"] = "Silverpine Forest",
        ["217-Ruins of Gilneas"] = "Silverpine Forest 2",
        ["21-Silverpine2"] = "Silverpine Forest 3",
        ["25-DEV-DALARAN_CRATER"] = "Silverpine Forest 4",
        ["21-Silverpine3"] = "Silverpine Forest 5",
        ["25-Hillsbrad"] = "WIP - Hillsbrad Foothills",
        ["22-Western Plaguelands"] = "WIP - Western Plaguelands",
    }
    ...
    APR.RouteList.Shadowlands = {
        ...
        ["1670-Shadowlands-StoryOnly-H"] = "SL - StoryMode Only",
    }
    APR.RouteList.Dragonflight = {
        ["85-DF01H-Orgrimmar"] = "DF01/02 - Dragonflight Orgrimmar/Durotar",
        ["2022-DF03H-WakingShores"] = "DF03 - Waking Shores - Horde",
        ["2022-DF03N-WakingShores"] = "DF04 - Waking Shores - Neutral",
    ...
    APR.RouteList.TheWarWithin = {
        ...
        ["2248-TWW-Undermine-part-1"] = "TWW - Undermine Part 1",
        ["2346-TWW-Undermine-part-2"] = "TWW - Undermine Part 2",
