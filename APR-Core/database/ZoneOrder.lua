APR.ZonesData = {
    ...
    ["SwitchCont"] = {
        ["Alliance"] = {
            ...
            { continent = 13,   nextContinent = 572,  nextZone = 17,   portalKey = "DarkPortal Talk",         closestTaxiNode = "Stormwind, Elwynn",                  extraText = "TALK_TO" },
            { continent = 13,   nextContinent = 572,  nextZone = 17,   portalKey = "DarkPortal" },
        ...
        ["Horde"] = {
            ...
            { continent = 12,   nextContinent = 572,  nextZone = 17,   portalKey = "DarkPortal Talk",        closestTaxiNode = "Orgrimmar, Durotar",                 extraText = "TALK_TO" },
            { continent = 12,   nextContinent = 572,  nextZone = 17,   portalKey = "DarkPortal" },
    ...
    ["ExtensionRouteMaps"] = { -- MapID for each Categorie
        ["Alliance"] = {
            Vanilla = { 14, 15, 17, 22, 23, 26, 27, 30, 32, 36, 37, 47, 48, 49, 51, 52, 56, 57, 62, 63, 64, 65, 66, 69, 70, 71, 77, 78, 81, 83, 84, 97, 106, 124, 179, 181, 199, 202, 224, 249, 425, 460, 468, 1409, 1726, 1727, 1728 },
            TheBurningCrusade = {},
