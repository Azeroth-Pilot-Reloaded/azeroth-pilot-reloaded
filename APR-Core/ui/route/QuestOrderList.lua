        ...
        for rawIndex, step in ipairs(activeRouteSteps) do
            ...
            if visible then
                ...
                if isCurrentStep then
                    currentDisplayIndex = displayStepIndex
                end
                ...
                elseif step.EnterScenario or step.EnterInstance then
                    ...
                    local scenarioTypeLabel = (scenarioInfo and scenarioInfo.type and L[scenarioInfo.type]) or
                        L["SCENARIO"] or
                        UNKNOWN
                ...
                elseif step.LeaveScenario or step.LeaveInstance then
                    local scenarioMapID      = step.LeaveScenario and step.LeaveScenario.mapID or
                        step.LeaveInstance.mapID
                ...
                elseif step.UseHS or step.UseDalaHS or step.UseGarrisonHS then
                    ...
                    local color = colorByCompletion(C_QuestLog.IsQuestFlaggedCompleted(questID), currentStepIndex,
                        rawIndex)
                    container, activeQuestId = QuestOrderListUtils:AddStepFrame(layout, displayStepIndex, questText,
                        color,
                        isCurrentStep)
