...
local waypoints = {
  ...
  },
  {
    ...
    from = {
      ...
      type = 1,
      unknown1 = 0,
      condition = function() return (UnitLevel("player") >= GetCorrectedLevel(85)) and (UnitFactionGroup("player") == "Alliance") end,
      important = true
    },
    to = {
      locaId = 22,
  ...
  },
  {
    ...
    from = {
      ...
      type = 1,
      unknown1 = 0,
      condition = function() return (UnitLevel("player") >= GetCorrectedLevel(85)) and (UnitFactionGroup("player") == "Horde") end,
      important = true
    },
    to = {
      locaId = 113,
