...
function APR:createStatusStaticContent(StatusFrame)
	...
	StatusFrame.Section2 = APR:createStatusSection(300, 105, nil, 30, StatusFrame, 'TOP', StatusFrame.Section1, 'BOTTOM', 0)
	...
	StatusFrame.Section3.Content.Line1.Text:SetFormattedText(statusInfos.charFaction[1] .. ': |cff' .. APR.HEXColor.green .. '%s|r', statusInfos.charFaction[2])
	StatusFrame.Section3.Content.Line2.Text:SetFormattedText(statusInfos.charName[1] .. ': |cff' .. APR.HEXColor.green .. '%s|r', statusInfos.charName[2] .. "-" .. statusInfos.charRealm[2])
	StatusFrame.Section3.Content.Line4.Text:SetFormattedText(statusInfos.charClass[1] .. ': |cff' .. APR.HEXColor.green .. '%s|r', statusInfos.charClass[2]:lower():gsub("^%l", string.upper))
end
...
function APR:updateStatusFrame()
	...
	StatusFrame.Section1.Content.Line4.Text:SetFormattedText(statusInfos.currentTime[1] .. ': |cff' .. APR.HEXColor.green ..'%s|r', statusInfos.currentTime[2])
