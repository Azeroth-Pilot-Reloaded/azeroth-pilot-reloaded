...
function APR.ResetSettings()
	...
	APR.OptionsFrame.AutoAcceptQuestRouteCheckButton:SetChecked(NumToBool(APR1[APR.Realm][APR.Name].Settings["AutoAcceptQuestRoute"]))
...
local function displayOptionSection(optionFrame, subOptionFrame, frameName, x, y, checkValue, text)
	...
	APR.OptionsFrame.MainFrame[optionFrame].FontString = APR.OptionsFrame.MainFrame:CreateFontString("APR_OptionsB3FS1","ARTWORK", "ChatFontNormal")
	APR.OptionsFrame.MainFrame[optionFrame].FontString:SetParent(APR.OptionsFrame.MainFrame[optionFrame])
	APR.OptionsFrame.MainFrame[optionFrame].FontString:SetPoint("CENTER", APR.OptionsFrame.MainFrame[optionFrame], "CENTER",0,0)
	...
	APR.OptionsFrame.MainFrame[subOptionFrame] = CreateFrame("frame", "APR_OptionsMainFrame_General",  APR_OptionsMainFrame)
...
local function checkboxOptionline(parentFrame, optionFrameButton, frameName, x, y, checkValue, text, optionalFunction)
	APR.OptionsFrame[optionFrameButton] = CreateFrame("CheckButton", frameName, APR.OptionsFrame.MainFrame[parentFrame], "ChatConfigCheckButtonTemplate");
	...
	optionalFunction = optionalFunction or function() APR1[APR.Realm][APR.Name].Settings[checkValue] = Booltonumber(APR.OptionsFrame[optionFrameButton]:GetChecked()) end
	APR.OptionsFrame[optionFrameButton]:SetScript("OnClick", optionalFunction)
end

local function sliderOptionLine(parentFrame, optionFrameSlide, frameName, x, y, checkValue, text, functionOnChanged, offset)
	APR.OptionsFrame[optionFrameSlide] = CreateFrame("Slider", frameName ,APR.OptionsFrame.MainFrame[parentFrame], "OptionsSliderTemplate")
	...
	APR.OptionsFrame[optionFrameSlide].minValue, APR.OptionsFrame[optionFrameSlide].maxValue = APR.OptionsFrame[optionFrameSlide]:GetMinMaxValues()
...
local function displayButton(parentFrame, optionFrameButton, frameName, width, height, x, y, pointValue, text, fontStyle, onClickFunction)
	APR.OptionsFrame[optionFrameButton] = CreateFrame("Button", frameName, parentFrame, "UIPanelButtonTemplate")

	APR.OptionsFrame[optionFrameButton].Fontstring = APR.OptionsFrame.MainFrame:CreateFontString("APRSettingsFS1","ARTWORK", "ChatFontNormal")
...
-------------------- Quest Options ----------------------------------------
	...
	displayOptionSection("OptionsB1", "OptionsQuests", "APR_OptionsMainFrame_QuestOptions", 0, -40, "TOPLEFT", L["Q_OPTIONS"])
	APR.OptionsFrame.MainFrame.OptionsQuests:Show()
	-- Auto pickup checkbox
	checkboxOptionline("OptionsQuests", "AutoAcceptCheckButton","APR_AutoAcceptCheckButton", 10, -10, "AutoAccept", L["ACCEPT_Q"])
	...
	checkboxOptionline("OptionsQuests", "AutoHandInCheckButton","APR_AutoHandInCheckButton", 10, -50, "AutoHandIn", L["TURN_IN_Q"])
	-- Auto handi item choice checkbox
	checkboxOptionline("OptionsQuests", "AutoHandInChoiceCheckButton","APR_AutoHandInChoiceCheckButton", 10, -70, "AutoHandInChoice", L["AUTO_PICK_REWARD_ITEM"])
	-- Display Quest list/ current step checkbox
	checkboxOptionline("OptionsQuests", "ShowQListCheckButton","APR_ShowQListCheckButton", 10, -90, "ShowQList", L["SHOW_QLIST"], function()
	...
	-- Display Quest list/ current step checkbox
	checkboxOptionline("OptionsQuests", "LockQuestListCheckButton","APR_LockQuestListCheckButton", 10, -110, "Lock", L["LOCK_QLIST_WINDOW"])
	-- Quest list/ current step scale slider
	sliderOptionLine("OptionsQuests", "QuestListScaleSlider", "APR_QuestListScaleSlider", 62, -150, "Scale", L["QLIST_SCALE"], function(self,event)
		event = event - event%1
	...
	sliderOptionLine("OptionsQuests", "QuestOrderListScaleSlider", "APR_QuestOrderListScaleSlider",62, -190, "OrderListScale", L["QORDERLIST_SCALE"], function(self,event)
		event = event - event%1
	...
	checkboxOptionline("OptionsQuests", "QorderListzCheckButton","APR_QorderListzCheckButton", 10, -215, "ShowQuestListOrder", L["SHOW_QORDERLIST"], function()
		APR1[APR.Realm][APR.Name].Settings.ShowQuestListOrder = Booltonumber(APR.OptionsFrame.QorderListzCheckButton:GetChecked())
	...
	displayButton(APR.OptionsFrame.MainFrame.OptionsQuests, "ResetQorderL", "APR_OptionsButtons3", 150, 30, 50, -245, "TOPLEFT", L["RESET_QORDERLIST"], "GameFontNormal", function(self, arg1)
		APR.ZoneQuestOrder:ClearAllPoints()
		APR.ZoneQuestOrder:SetPoint("CENTER", UIParent, "CENTER",1,1)
	end)
----------------- Arrow Options --------------------------------------------------------------------------------------------
	displayOptionSection("OptionsB2", "OptionsArrow", "APR_OptionsMainFrame_ArrowOptions", 0, -70, "TOPLEFT", L["ARROW_OPTION"])
	-- Arrow locker checkbox
	checkboxOptionline("OptionsArrow", "LockArrowCheckButton", "APR_LockArrowCheckButton", 10, -10, "LockArrow", L["LOCK_ARROW_WINDOW"])
	-- Display arrow checkbox
	checkboxOptionline("OptionsArrow", "ShowArrowCheckButton", "APR_ShowArrowCheckButton", 10, -30, "ShowArrow", L["SHOW_ARROW"], function()
	...
	-- Arrow scale slider
	sliderOptionLine("OptionsArrow", "ArrowScaleSlider", "APR_ArrowScaleSlider", 62, -70, "ArrowScale", L["ARROW_SCALE"], function(self,event)
		event = event - event%1
		APR1[APR.Realm][APR.Name].Settings.ArrowScale = event / 100
		APR.ArrowFrame:SetScale(APR1[APR.Realm][APR.Name].Settings.ArrowScale)
	end)
	-- Update arrow FPS slider
	sliderOptionLine("OptionsArrow", "ArrowFpsSlider", "APR_ArrowFpsSlider", 62, -110, "ArrowFPS", L["UPDATE_ARROW"].." "..APR1[APR.Realm][APR.Name].Settings["ArrowFPS"].." FPS", function(self,event)
		event = event - event%1
	...
	-- Reset arrow button
	displayButton(APR.OptionsFrame.MainFrame.OptionsArrow, "ResetARrow", "APR_OptionsButtons3", 90, 30, 50, -140, "TOPLEFT", L["RESET_ARROW"], "GameFontNormal", function(self, arg1)
		APR1[APR.Realm][APR.Name].Settings["ArrowScale"] = UIParent:GetScale()
		APR1[APR.Realm][APR.Name].Settings["LockArrow"] = 0
		APR1[APR.Realm][APR.Name].Settings["ArrowFPS"] = 2
		APR1[APR.Realm][APR.Name].Settings["arrowleft"] = GetScreenWidth() / 2.05
...
------------------------- General Options --------------------------------------------------------------------------
	displayOptionSection("OptionsB3", "OptionsGeneral", "APR_OptionsMainFrame_GeneralOptions", 0, -100, "TOPLEFT", L["ARROW_OPTION"])
	-- auto skip scene checkbox
	checkboxOptionline("OptionsGeneral", "CutSceneCheckButton", "APR_CutSceneCheckButton", 10, -10, "CutScene", L["SKIPPED_CUTSCENE"])
	-- auto sell checkbox
	checkboxOptionline("OptionsGeneral", "AutoVendorCheckButton", "APR_AutoVendorCheckButton", 10, -30, "AutoVendor", L["AUTO_VENDOR"])
	-- auto repair checkbox
	checkboxOptionline("OptionsGeneral", "AutoRepairCheckButton", "APR_AutoRepairCheckButton", 10, -50, "AutoRepair", L["AUTO_REPAIR"])
	-- Group progress checkbox
	checkboxOptionline("OptionsGeneral", "ShowGroupCheckButton", "APR_ShowGroupCheckButton", 10, -70, "AutoRepair", L["SHOW_GROUP_PROGRESS"], function()
	...
	checkboxOptionline("OptionsGeneral", "AutoGossipCheckButton", "APR_AutoGossipCheckButton", 10, -90, "AutoGossip", L["AUTO_SELECTION_OF_DIALOG"])
	-- auto fly checkbox
	checkboxOptionline("OptionsGeneral", "AutoFlightCheckButton", "APR_AutoFlightCheckButton", 10, -110, "AutoFlight", L["AUTO_USE_FLIGHTPATHS"])
	-- MiniMap quest blob display checkbox
	checkboxOptionline("OptionsGeneral", "BlobsShowCheckButton", "APR_BlobsShowCheckButton", 10, -130, "ShowBlobs", L["SHOW_BLOBS_ON_MINIMAP"], function()
	...
	sliderOptionLine("OptionsGeneral", "MiniMapBlobAlphaSlider", "APR_MiniMapBlobAlphaSlider", 62, -160, "MiniMapBlobAlpha", L["MINIMAP_BLOB_ALPHA"], function(self,event)
		event = event - event%1
	...
	checkboxOptionline("OptionsGeneral", "MapBlobsShowCheckButton", "APR_MapBlobsShowCheckButton", 10, -180, "ShowMapBlobs", L["SHOW_BLOBS_ON_MAP"], function()
	...
	checkboxOptionline("OptionsGeneral", "ShowMap10sCheckButton", "APR_ShowMap10sCheckButton", 10, -200, "ShowMap10s", L["SHOW_STEPS_MAP"], function()
	...
	-- Heirloom checkbox
	checkboxOptionline("OptionsGeneral", "QuestButtonsCheckButton", "APR_QuestButtonsCheckButton", 10, -220, "QuestButtonDetatch", L["DETACH_Q_ITEM_BTN"], function()
		APR1[APR.Realm][APR.Name].Settings.QuestButtonDetatch = Booltonumber(APR.OptionsFrame.QuestButtonsCheckButton:GetChecked())
	...
	sliderOptionLine("OptionsGeneral", "QuestButtonsSlider", "APR_QuestButtonsSlider", 62, -260, "QuestButtons", L["Q_BTN_SCALE"], function(self,event)
		event = event - event%1
	...
	-- Heirloom checkbox
	checkboxOptionline("OptionsGeneral", "DisableHeirloomWarningCheckButton", "APR_DisableHeirloomWarningCheckButton", 10, -280, "DisableHeirloomWarning", L["DISABLE_HEIRLOOM_WARNING"], function()
		APR1[APR.Realm][APR.Name].Settings.DisableHeirloomWarning = Booltonumber(APR.OptionsFrame.DisableHeirloomWarningCheckButton:GetChecked())
		APR.BookingList.PrintQStep = 1
	end)
	...
	-- Keybind button
	displayButton(APR.OptionsFrame.MainFrame, "Button2", "APR_OptionsButtons2", 100, 30, -175, 5, "BOTTOMRIGHT", L["KEYBINDS"], "GameFontNormal", function(self, arg1)
		ShowUIPanel(KeyBindingFrame)
	end)
	-- Reset button
	displayButton(APR.OptionsFrame.MainFrame, "Button3", "APR_OptionsButtons3", 70, 30, -80, 5, "BOTTOMRIGHT", L["RESET"], "GameFontNormal", function(self, arg1)
		APR.ResetSettings()
	end)
	-- Close button
	displayButton(APR.OptionsFrame.MainFrame, "Button1", "APR_OptionsButtons1", 70, 30, -5, 5, "BOTTOMRIGHT", L["CLOSE"], "GameFontNormal", function(self, arg1)
		APR.OptionsFrame.MainFrame:Hide()
		APR.SettingsOpen = 0
