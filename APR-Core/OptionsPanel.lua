...
APR_panel.Button1:SetText("Load")
...
APR.OptionsFrame.MainFrame.OptionsB1.texture = t
	...
	APR.OptionsFrame.MainFrame.OptionsB1.FontString:SetText("Quest Options")
...
APR.OptionsFrame.MainFrame.OptionsQuests.texture = t
	...
	getglobal(APR.OptionsFrame.AutoAcceptCheckButton:GetName() .. 'Text'):SetText(": "..L["Accept Quest"])
	...
	getglobal(APR.OptionsFrame.AutoHandInCheckButton:GetName() .. 'Text'):SetText(": "..L["Turn in Quest"])
	...
	getglobal(APR.OptionsFrame.AutoHandInChoiceCheckButton:GetName() .. 'Text'):SetText(": "..L["Choose Reward Ilvl"])
	...
	getglobal(APR.OptionsFrame.ShowQListCheckButton:GetName() .. 'Text'):SetText(": "..L["Show QuestList"])
	...
	getglobal(APR.OptionsFrame.LockQuestListCheckButton:GetName() .. 'Text'):SetText(": "..L["Lock QuestList"])
	...
	getglobal(APR.OptionsFrame.QuestListScaleSlider:GetName() .. 'Text'):SetText("QuestList Scale:")
	...
	getglobal(APR.OptionsFrame.QuestOrderListScaleSlider:GetName() .. 'Text'):SetText("Quest Order List Scale:")
	...
	getglobal(APR.OptionsFrame.QorderListzCheckButton:GetName() .. 'Text'):SetText(": Show QuestOrderList")
	...
	APR.OptionsFrame["ResetQorderL"]:SetText("Reset QuestOrderList")
...
APR.OptionsFrame.MainFrame.OptionsB2.texture = t
	...
	APR.OptionsFrame.MainFrame.OptionsB2.FontString:SetText("Arrow Options")
...
APR.OptionsFrame.MainFrame.OptionsArrow.texture = t
	...
	getglobal(APR.OptionsFrame.LockArrowCheckButton:GetName() .. 'Text'):SetText(": "..L["Lock Arrow"])
	...
	getglobal(APR.OptionsFrame.ShowArrowCheckButton:GetName() .. 'Text'):SetText(": "..L["Show Arrow"])
	...
	getglobal(APR.OptionsFrame.ArrowScaleSlider:GetName() .. 'Text'):SetText("Arrow Scale:")
	...
	getglobal(APR.OptionsFrame.ArrowFpsSlider:GetName() .. 'Text'):SetText("Update Arrow every "..APR1[APR.Realm][APR.Name]["Settings"]["ArrowFPS"].." FPS:")
	...
	APR.OptionsFrame["ResetARrow"]:SetText("Reset Arrow")
...
APR.OptionsFrame.MainFrame.OptionsB3.texture = t
	...
	APR.OptionsFrame.MainFrame.OptionsB3.FontString:SetText("General Options")
...
APR.OptionsFrame.MainFrame.OptionsGeneral.texture = t
	...
	getglobal(APR.OptionsFrame.CutSceneCheckButton:GetName() .. 'Text'):SetText(": "..L["Skipped cutscene"])
	...
	getglobal(APR.OptionsFrame.AutoVendorCheckButton:GetName() .. 'Text'):SetText(": "..L["AutoVendor"])
	...
	getglobal(APR.OptionsFrame.AutoRepairCheckButton:GetName() .. 'Text'):SetText(": "..L["AutoRepair"])
	...
	getglobal(APR.OptionsFrame.ShowGroupCheckButton:GetName() .. 'Text'):SetText(": "..L["ShowGroup"])
	...
	getglobal(APR.OptionsFrame.AutoGossipCheckButton:GetName() .. 'Text'):SetText(": "..L["Auto-selection of dialog"])
	...
	getglobal(APR.OptionsFrame.BlobsShowCheckButton:GetName() .. 'Text'):SetText(": "..L["ShowBlobs"])
	...
	getglobal(APR.OptionsFrame.MiniMapBlobAlphaSlider:GetName() .. 'Text'):SetText("Set Minimap blobs alpha")
	...
	getglobal(APR.OptionsFrame.MapBlobsShowCheckButton:GetName() .. 'Text'):SetText(": "..L["ShowMapBlobs"])
	...
	getglobal(APR.OptionsFrame.ShowMap10sCheckButton:GetName() .. 'Text'):SetText(": Show 10 steps on map")
	...
	getglobal(APR.OptionsFrame.DisableHeirloomWarningCheckButton:GetName() .. 'Text'):SetText(": Disable Heirloom Warning")
	...
	getglobal(APR.OptionsFrame.QuestButtonsCheckButton:GetName() .. 'Text'):SetText(": Detatch Quest Item Buttons")
	...
	getglobal(APR.OptionsFrame.QuestButtonsSlider:GetName() .. 'Text'):SetText("Quest Buttons Scale")
	...
	APR.OptionsFrame["Button1"]:SetText("Close")
	...
	APR.OptionsFrame["ShowStuffs"]:SetText("Custom Path")
	...
	APR.OptionsFrame["ShowStuffs2"]:SetText("Auto Path Helper")
	...
	APR.OptionsFrame["Button3"]:SetText("Reset")
