...
-------------------- Q Options ----------------------------------------
	APR.OptionsFrame.MainFrame.OptionsB1 = CreateFrame("frame", "APR_OptionsMainFrame_QOptions",  APR_OptionsMainFrame)
...
APR.OptionsFrame.MainFrame.OptionsB1.texture = t
	...
	APR.OptionsFrame.MainFrame.OptionsB1:SetScript("OnMouseDown", function(self, button)
		if button == "LeftButton" then
			APR.OptionsFrame.MainFrame.OptionsQs:Show()
	...
	APR.OptionsFrame.MainFrame.OptionsQs = CreateFrame("frame", "APR_OptionsMainFrame_Qs",  APR_OptionsMainFrame)
	APR.OptionsFrame.MainFrame.OptionsQs:SetWidth(295)
	APR.OptionsFrame.MainFrame.OptionsQs:SetHeight(320)
	APR.OptionsFrame.MainFrame.OptionsQs:SetFrameStrata("MEDIUM")
	APR.OptionsFrame.MainFrame.OptionsQs:SetPoint("LEFT",  APR_OptionsMainFrame, "LEFT",155,-20)
	APR.OptionsFrame.MainFrame.OptionsQs:SetMovable(true)
	APR.OptionsFrame.MainFrame.OptionsQs:EnableMouse(true)

local t = APR.OptionsFrame.MainFrame.OptionsQs:CreateTexture(nil,"BACKGROUND")
t:SetTexture("Interface\\DialogFrame\\UI-DialogBox-Background")
t:SetAllPoints(APR.OptionsFrame.MainFrame.OptionsQs)
APR.OptionsFrame.MainFrame.OptionsQs.texture = t

	APR.OptionsFrame.MainFrame.OptionsQs:SetScript("OnMouseDown", function(self, button)
		if button == "LeftButton" and not APR.OptionsFrame.MainFrame.isMoving then
			APR.OptionsFrame.MainFrame:StartMoving();
			APR.OptionsFrame.MainFrame.isMoving = true;
		end
	end)
	APR.OptionsFrame.MainFrame.OptionsQs:SetScript("OnMouseUp", function(self, button)
		if button == "LeftButton" and APR.OptionsFrame.MainFrame.isMoving then
			APR.OptionsFrame.MainFrame:StopMovingOrSizing();
			APR.OptionsFrame.MainFrame.isMoving = false;
		end
	end)
	APR.OptionsFrame.MainFrame.OptionsQs:SetScript("OnHide", function(self)
		if ( APR.OptionsFrame.MainFrame.isMoving ) then
			APR.OptionsFrame.MainFrame:StopMovingOrSizing();
			APR.OptionsFrame.MainFrame.isMoving = false;
		end
	end)
	APR.OptionsFrame.MainFrame.OptionsQs:Hide()
		APR.OptionsFrame.AutoAcceptCheckButton = CreateFrame("CheckButton", "APR_AutoAcceptCheckButton", APR.OptionsFrame.MainFrame.OptionsQs, "ChatConfigCheckButtonTemplate");
	APR.OptionsFrame.AutoAcceptCheckButton:SetPoint("TOPLEFT", APR.OptionsFrame.MainFrame.OptionsQs, "TOPLEFT", 10, -10)
	...
	APR.OptionsFrame.AutoHandInCheckButton = CreateFrame("CheckButton", "APR_AutoHandInCheckButton", APR.OptionsFrame.MainFrame.OptionsQs, "ChatConfigCheckButtonTemplate");
	APR.OptionsFrame.AutoHandInCheckButton:SetPoint("TOPLEFT", APR.OptionsFrame.MainFrame.OptionsQs, "TOPLEFT", 10, -30)
	...
	APR.OptionsFrame.AutoHandInChoiceCheckButton = CreateFrame("CheckButton", "APR_AutoHandInChoiceCheckButton", APR.OptionsFrame.MainFrame.OptionsQs, "ChatConfigCheckButtonTemplate");
	APR.OptionsFrame.AutoHandInChoiceCheckButton:SetPoint("TOPLEFT", APR.OptionsFrame.MainFrame.OptionsQs, "TOPLEFT", 10, -50)
	...
	APR.OptionsFrame.ShowQListCheckButton = CreateFrame("CheckButton", "APR_ShowQListCheckButton", APR.OptionsFrame.MainFrame.OptionsQs, "ChatConfigCheckButtonTemplate");
	APR.OptionsFrame.ShowQListCheckButton:SetPoint("TOPLEFT", APR.OptionsFrame.MainFrame.OptionsQs, "TOPLEFT", 10, -70)
	...
	APR.OptionsFrame.LockQListCheckButton = CreateFrame("CheckButton", "APR_LockQListCheckButton", APR.OptionsFrame.MainFrame.OptionsQs, "ChatConfigCheckButtonTemplate");
	APR.OptionsFrame.LockQListCheckButton:SetPoint("TOPLEFT", APR.OptionsFrame.MainFrame.OptionsQs, "TOPLEFT", 10, -90)
	if (APR1[APR.Realm][APR.Name]["Settings"]["Lock"] == 0) then
		APR.OptionsFrame.LockQListCheckButton:SetChecked(false)
	else
		APR.OptionsFrame.LockQListCheckButton:SetChecked(true)
	end
	getglobal(APR.OptionsFrame.LockQListCheckButton:GetName() .. 'Text'):SetText(": "..L["LOCK_QLIST_WINDOW"])
	getglobal(APR.OptionsFrame.LockQListCheckButton:GetName() .. 'Text'):SetTextColor(1, 1, 1)
	APR.OptionsFrame.LockQListCheckButton:SetScript("OnClick", function()
		if (APR.OptionsFrame.LockQListCheckButton:GetChecked() == true) then
			APR1[APR.Realm][APR.Name]["Settings"]["Lock"] = 1
		else
			APR1[APR.Realm][APR.Name]["Settings"]["Lock"] = 0
		end
	end)
	APR.OptionsFrame.QListScaleSlider = CreateFrame("Slider", "APR_QListScaleSlider",APR.OptionsFrame.MainFrame.OptionsQs, "OptionsSliderTemplate")
	APR.OptionsFrame.QListScaleSlider:SetWidth(160)
	APR.OptionsFrame.QListScaleSlider:SetHeight(15)
	APR.OptionsFrame.QListScaleSlider:SetPoint("TOPLEFT", APR.OptionsFrame.MainFrame.OptionsQs, "TOPLEFT", 20, -120)
	APR.OptionsFrame.QListScaleSlider:SetOrientation("HORIZONTAL")
	APR.OptionsFrame.QListScaleSlider:SetMinMaxValues(1, 200)
	APR.OptionsFrame.QListScaleSlider.minValue, APR.OptionsFrame.QListScaleSlider.maxValue = APR.OptionsFrame.QListScaleSlider:GetMinMaxValues()
	getglobal(APR.OptionsFrame.QListScaleSlider:GetName() .. 'Low'):SetText("1%")
	getglobal(APR.OptionsFrame.QListScaleSlider:GetName() .. 'High'):SetText("200%")
	getglobal(APR.OptionsFrame.QListScaleSlider:GetName() .. 'Text'):SetText(L["QLIST_SCALE"]..":")
	APR.OptionsFrame.QListScaleSlider:SetValueStep(1)
	APR.OptionsFrame.QListScaleSlider:SetValue(100)
	APR.OptionsFrame.QListScaleSlider:SetScript("OnValueChanged", function(self,event)
		event = event - event%1
		APR1[APR.Realm][APR.Name]["Settings"]["Scale"] = event / 100
		APR.QList.ButtonParent:SetScale(APR1[APR.Realm][APR.Name]["Settings"]["Scale"])
		APR.QList.ListFrame:SetScale(APR1[APR.Realm][APR.Name]["Settings"]["Scale"])
		APR.QList21:SetScale(APR1[APR.Realm][APR.Name]["Settings"]["Scale"])
	end)
	APR.OptionsFrame.QListScaleSlider:SetScript("OnMouseWheel", function(self,delta)
		if tonumber(self:GetValue()) == nil then return end
		self:SetValue(tonumber(self:GetValue())+delta)
	end)
	APR.OptionsFrame.QListScaleSlider:SetValue(APR1[APR.Realm][APR.Name]["Settings"]["Scale"] * 100)

	APR.OptionsFrame.QOrderListScaleSlider = CreateFrame("Slider", "APR_QOrderListScaleSlider",APR.OptionsFrame.MainFrame.OptionsQs, "OptionsSliderTemplate")
	APR.OptionsFrame.QOrderListScaleSlider:SetWidth(160)
	APR.OptionsFrame.QOrderListScaleSlider:SetHeight(15)
	APR.OptionsFrame.QOrderListScaleSlider:SetPoint("TOPLEFT", APR.OptionsFrame.MainFrame.OptionsQs, "TOPLEFT", 20, -160)
	APR.OptionsFrame.QOrderListScaleSlider:SetOrientation("HORIZONTAL")
	APR.OptionsFrame.QOrderListScaleSlider:SetMinMaxValues(1, 200)
	APR.OptionsFrame.QOrderListScaleSlider.minValue, APR.OptionsFrame.QOrderListScaleSlider.maxValue = APR.OptionsFrame.QOrderListScaleSlider:GetMinMaxValues()
	getglobal(APR.OptionsFrame.QOrderListScaleSlider:GetName() .. 'Low'):SetText("1%")
	getglobal(APR.OptionsFrame.QOrderListScaleSlider:GetName() .. 'High'):SetText("200%")
	getglobal(APR.OptionsFrame.QOrderListScaleSlider:GetName() .. 'Text'):SetText(L["QORDERLIST_SCALE"]..":")
	APR.OptionsFrame.QOrderListScaleSlider:SetValueStep(1)
	APR.OptionsFrame.QOrderListScaleSlider:SetValue(100)
	APR.OptionsFrame.QOrderListScaleSlider:SetScript("OnValueChanged", function(self,event)
		event = event - event%1
		APR1[APR.Realm][APR.Name]["Settings"]["OrderListScale"] = event / 100
		APR.ZoneQOrder:SetScale(APR1[APR.Realm][APR.Name]["Settings"]["OrderListScale"])
	end)
	APR.OptionsFrame.QOrderListScaleSlider:SetScript("OnMouseWheel", function(self,delta)
		if tonumber(self:GetValue()) == nil then return end
		self:SetValue(tonumber(self:GetValue())+delta)
	end)
	APR.OptionsFrame.QOrderListScaleSlider:SetValue(APR1[APR.Realm][APR.Name]["Settings"]["OrderListScale"] * 100)

	APR.OptionsFrame.QorderListzCheckButton = CreateFrame("CheckButton", "APR_QorderListzCheckButton", APR.OptionsFrame.MainFrame.OptionsQs, "ChatConfigCheckButtonTemplate");
	APR.OptionsFrame.QorderListzCheckButton:SetPoint("TOPLEFT", APR.OptionsFrame.MainFrame.OptionsQs, "TOPLEFT", 10, -185)
	if (APR1[APR.Realm][APR.Name]["Settings"]["ShowQListOrder"] == 0) then
	...
	APR.OptionsFrame.QorderListzCheckButton:SetScript("OnClick", function()
		if (APR.OptionsFrame.QorderListzCheckButton:GetChecked() == true) then
			...
			APR1[APR.Realm][APR.Name]["Settings"]["ShowQListOrder"] = 1
			APR.ZoneQOrder:Show()
		else
	...
	APR.OptionsFrame["ResetQorderL"] = CreateFrame("Button", "APR_OptionsButtons3", APR.OptionsFrame.MainFrame.OptionsQs, "SecureActionButtonTemplate")
	APR.OptionsFrame["ResetQorderL"]:SetPoint("TOPLEFT", APR.OptionsFrame.MainFrame.OptionsQs, "TOPLEFT", 10, -210)
	...
	APR.OptionsFrame["ResetQorderL"]:SetParent(APR.OptionsFrame.MainFrame.OptionsQs)
...
--	APR.OptionsFrame.ResetQorderL:SetNormalTexture(APR.OptionsFrame.ResetQorderLntex)
	...
	APR.OptionsFrame["ResetQorderL"]:SetScript("OnClick", function(self, arg1)
		APR.ZoneQOrder:ClearAllPoints()
		APR.ZoneQOrder:SetPoint("CENTER", UIParent, "CENTER",1,1)
	end)
...
APR.OptionsFrame.MainFrame.OptionsGeneral.texture = t
	...
	APR.OptionsFrame.QButtonsCheckButton = CreateFrame("CheckButton", "APR_QButtonsCheckButton", APR.OptionsFrame.MainFrame.OptionsGeneral, "ChatConfigCheckButtonTemplate");
	APR.OptionsFrame.QButtonsCheckButton:SetPoint("TOPLEFT", APR.OptionsFrame.MainFrame.OptionsGeneral, "TOPLEFT", 10, -200)
	if (APR1[APR.Realm][APR.Name]["Settings"]["QButtonDetatch"] == 0) then
		APR.OptionsFrame.QButtonsCheckButton:SetChecked(false)
	else
		APR.OptionsFrame.QButtonsCheckButton:SetChecked(true)
	end
	getglobal(APR.OptionsFrame.QButtonsCheckButton:GetName() .. 'Text'):SetText(L["DETACH_Q_ITEM_BTN"])
	getglobal(APR.OptionsFrame.QButtonsCheckButton:GetName() .. 'Text'):SetTextColor(1, 1, 1)
	APR.OptionsFrame.QButtonsCheckButton:SetScript("OnClick", function()
		if (APR.OptionsFrame.QButtonsCheckButton:GetChecked() == true) then
			APR1[APR.Realm][APR.Name]["Settings"]["QButtonDetatch"] = 1
			APR.OptionsFrame.QButtonsSlider:Show()
		else
			...
			for CLi = 1, 3 do
				...
				APR.QList2["BF"..CLi]["APR_Button"]:SetScale(APR1[APR.Realm][APR.Name]["Settings"]["QButtons"])
				APR.OptionsFrame.QButtonsSlider:SetValue(APR1[APR.Realm][APR.Name]["Settings"]["QButtons"] * 100)
			end
			APR.OptionsFrame.QButtonsSlider:Hide()
		end
	end)

	APR.OptionsFrame.QButtonsCheckButton:Hide()

	APR.OptionsFrame.QButtonsSlider = CreateFrame("Slider", "APR_QButtonsSlider",APR.OptionsFrame.MainFrame.OptionsGeneral, "OptionsSliderTemplate")
	APR.OptionsFrame.QButtonsSlider:SetWidth(160)
	APR.OptionsFrame.QButtonsSlider:SetHeight(15)
	APR.OptionsFrame.QButtonsSlider:SetPoint("TOPLEFT", APR.OptionsFrame.MainFrame.OptionsGeneral, "TOPLEFT", 20, -240)
	APR.OptionsFrame.QButtonsSlider:SetOrientation("HORIZONTAL")
	APR.OptionsFrame.QButtonsSlider:SetMinMaxValues(1, 200)
	APR.OptionsFrame.QButtonsSlider.minValue, APR.OptionsFrame.QButtonsSlider.maxValue = APR.OptionsFrame.QButtonsSlider:GetMinMaxValues()
	getglobal(APR.OptionsFrame.QButtonsSlider:GetName() .. 'Low'):SetText("1%")
	getglobal(APR.OptionsFrame.QButtonsSlider:GetName() .. 'High'):SetText("200%")
	getglobal(APR.OptionsFrame.QButtonsSlider:GetName() .. 'Text'):SetText(L["Q_BTN_SCALE"])
	APR.OptionsFrame.QButtonsSlider:SetValueStep(1)
	APR.OptionsFrame.QButtonsSlider:SetValue(100)
	APR.OptionsFrame.QButtonsSlider:SetScript("OnValueChanged", function(self,event)
		event = event - event%1
		APR1[APR.Realm][APR.Name]["Settings"]["QButtons"] = event / 100
		local CLi
		for CLi = 1, 20 do
			APR.QList2["BF"..CLi]["APR_Button"]:SetScale(APR1[APR.Realm][APR.Name]["Settings"]["QButtons"])
		end
	end)
	APR.OptionsFrame.QButtonsSlider:SetScript("OnMouseWheel", function(self,delta)
		if tonumber(self:GetValue()) == nil then return end
		self:SetValue(tonumber(self:GetValue())+delta)
	end)
	APR.OptionsFrame.QButtonsSlider:SetValue(APR1[APR.Realm][APR.Name]["Settings"]["QButtons"] * 100)
	if (APR1[APR.Realm][APR.Name]["Settings"]["QButtonDetatch"] == 1) then
		APR.OptionsFrame.QButtonsSlider:Show()
	else
		APR.OptionsFrame.QButtonsSlider:Hide()
	end
