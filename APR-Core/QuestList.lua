...
local function APR_CreateQuestList()
	...
	APR.QuestList.Greetings2FS221:SetText("Note, some routes may require a Goblin Glider Kit.")
	...
	APR.QuestList.Greetings2FS2:SetText("Special thanks to Zyrreal for making the original AAP.")
	...
	APR.QuestList.Greetings2FS3:SetText("Developers: Rycia, Neogeekmo, Deathmessinger, Pahonix")
	...
	APR.QuestList.Greetings2FS3:SetJustifyH("LEFT")
	APR.QuestList.Greetings2FS3:SetFontObject("GameFontNormal")
	APR.QuestList.Greetings2FS3:SetText("Support: NightofStarrs")
	...
	APR.QuestList.Greetings2FS3:SetJustifyH("LEFT")
	APR.QuestList.Greetings2FS3:SetFontObject("GameFontNormal")
	APR.QuestList.Greetings2FS3:SetText("Need help ?")
