...
APR.FP.ToyFrame.texture = t
			...
			if (APR.Faction == "Horde") then
				if (PlayerHasToy(150745) and C_QLog.IsQFlaggedCompleted(47956) == false) then
				...
				if (PlayerHasToy(150744) and C_QLog.IsQFlaggedCompleted(47954) == false) then
				...
				if (C_QLog.IsQFlaggedCompleted(47954) and C_QLog.IsQFlaggedCompleted(47956)) then
					APR.FP.ToyFrame:Hide()
				else
					C_Timer.After(5, APR.FP.testClickedFPS)
				end
			elseif (APR.Faction == "Alliance") then
				if (PlayerHasToy(150743) and C_QLog.IsQFlaggedCompleted(47954) == false) then
				...
				if (PlayerHasToy(150746) and C_QLog.IsQFlaggedCompleted(47956) == false) then
				...
				if (APR.Faction == "Alliance" and (C_QLog.IsQFlaggedCompleted(47954) or PlayerHasToy(150743) == false) and (C_QLog.IsQFlaggedCompleted(47956) or PlayerHasToy(150746) == false)) then
					APR.FP.ToyFrame:Hide()
				elseif (APR.Faction == "Horde" and (C_QLog.IsQFlaggedCompleted(47954) or PlayerHasToy(150744) == false) and (C_QLog.IsQFlaggedCompleted(47956) or PlayerHasToy(150745) == false)) then
					APR.FP.ToyFrame:Hide()
				else
					C_Timer.After(5, APR.FP.testClickedFPS)
				end
...
function APR.FP.testClickedFPS()
	...
	elseif (APR.Faction == "Horde" and (C_QLog.IsQFlaggedCompleted(47954) or PlayerHasToy(150744) == false) and (C_QLog.IsQFlaggedCompleted(47956) or PlayerHasToy(150745) == false)) then
		...
		if (APR.Faction == "Alliance") then
			if (C_QLog.IsQFlaggedCompleted(47956) and APR.FP.ToyFrame.F2) then
				APR.FP.ToyFrame.F2:Hide()
			end
			if (C_QLog.IsQFlaggedCompleted(47954) and APR.FP.ToyFrame.F1) then
				APR.FP.ToyFrame.F1:Hide()
			end
		elseif (APR.Faction == "Horde") then
			if (C_QLog.IsQFlaggedCompleted(47956) and APR.FP.ToyFrame.F1) then
				APR.FP.ToyFrame.F1:Hide()
			end
			if (C_QLog.IsQFlaggedCompleted(47954) and APR.FP.ToyFrame.F2) then
				APR.FP.ToyFrame.F2:Hide()
			end
		end
...
function APR.FP.GetCustomZone()
	...
	if (zenr == 0 and UnitFactionGroup("player") == "Alliance" and C_QLog.IsQFlaggedCompleted(59751) == false and (C_QLog.IsQFlaggedCompleted(60545) == true or C_QLog.IsOnQ(60545) == true)) then
		return 84, "84-IntroQline"
	end
	if (zenr == 0 and UnitFactionGroup("player") == "Horde" and C_QLog.IsQFlaggedCompleted(59751) == false and (C_QLog.IsQFlaggedCompleted(61874) == true or C_QLog.IsOnQ(61874) == true)) then
		return 85, "85-IntroQline"
	end
	if (zenr == 0 and not Map and C_QLog.IsOnQ(57159)) then
		return APR.QStepListListingZone["Z-12-Revendreth-Story"], "1525-Z12-Revendreth-Story"
	end
	if (zenr == 0 and C_QLog.IsOnQ(57876) and C_QLog.IsQFlaggedCompleted(57876) == false) then
	...
	if (zenr == 0 and APR.Level > 49) then
		...
		APR.ProgressShown = 0
		if (C_QLog.IsQFlaggedCompleted(58086) == false and (C_QLog.IsOnQ(61874) == true or C_QLog.IsQFlaggedCompleted(61874) == true or C_QLog.IsOnQ(59751) or C_QLog.IsQFlaggedCompleted(59751) == true)) then
			...
			if (C_QLog.IsQFlaggedCompleted(57693) == false) then
				APR.ProgressShown = 1
				return APR.QStepListListingZone["Z-13-The Maw-Story"], "1543-Z13-TheMaw-Story"
			end
			if (C_QLog.IsQFlaggedCompleted(57876) == false) then
				APR.ProgressShown = 1
				return APR.QStepListListingZone["Z-14-Revendreth-Story"], "1525-Z14-Revendreth-Story"
			end
			if (C_QLog.IsQFlaggedCompleted(57878) == false) then
				APR.ProgressShown = 1
				return APR.QStepListListingZone["Z-15-Oribos-Story"], "1671-Z15-Oribos-Story"
			end
		elseif (C_QLog.IsOnQ(61874) == true or C_QLog.IsQFlaggedCompleted(61874) == true) then
	...
	elseif (zenr == 0) then
		...
		if (C_QLog.IsQFlaggedCompleted(34398) == false and APR.Faction == "Alliance") then
			APR.ProgressShown = 1
			return APR.QStepListListingZone["(1/7) 1-50 Stormwind"], "A84-DesMephisto-Stormwind-War"
		end
		if (C_QLog.IsQFlaggedCompleted(35884) == false and APR.Faction == "Alliance") then
			APR.ProgressShown = 1
			return APR.QStepListListingZone["(2/7) 1-50 Tanaan Jungle"], "A577-DesMephisto-TanaanJungle"
		end
		if (C_QLog.IsQFlaggedCompleted(35556) == false and APR.Faction == "Alliance") then
			APR.ProgressShown = 1
			return APR.QStepListListingZone["(3/7) 1-50 Shadowmoon"], "A539-DesMephisto-Shadowmoon1"
		end
		if (C_QLog.IsQFlaggedCompleted(36937) == false and APR.Faction == "Alliance") then
			APR.ProgressShown = 1
			return APR.QStepListListingZone["(4/7) 1-50 Gorgrond"], "A543-DesMephisto-Gorgrond"
		end
		if (C_QLog.IsQFlaggedCompleted(34587) == false and APR.Faction == "Alliance") then
			APR.ProgressShown = 1
			return APR.QStepListListingZone["(5/7) 1-50 Talador"], "A535-DesMephisto-Talador"
		end
		if (C_QLog.IsQFlaggedCompleted(34624) == false and APR.Faction == "Alliance") then
			APR.ProgressShown = 1
			return APR.QStepListListingZone["(6/7) 1-50 Shadowmoon"], "A539-DesMephisto-Shadowmoon2"
		end
		if (C_QLog.IsQFlaggedCompleted(34707) == false and APR.Faction == "Alliance") then
			APR.ProgressShown = 1
			return APR.QStepListListingZone["(7/7) 1-50 Talador"], "A535-DesMephisto-Talador2"
		end

	end
	if (zenr == 0 and C_QLog.IsQFlaggedCompleted(62023) == true and C_QLog.IsQFlaggedCompleted(57904) == false) then
		APR.ProgressShown = 1
		return 1533, "1670-Kyrian"
	end
	if (zenr == 0 and C_QLog.IsQFlaggedCompleted(62019) == true and C_QLog.IsQFlaggedCompleted(58159) == false) then
		APR.ProgressShown = 1
		return 1565, "1670-NightFae"
	end
	if (zenr == 0 and C_QLog.IsQFlaggedCompleted(62020) == true and C_QLog.IsQFlaggedCompleted(59320) == false) then
		APR.ProgressShown = 1
		return 1525, "1670-Venthyr"
	end
	if (zenr == 0 and C_QLog.IsQFlaggedCompleted(62017) == true and C_QLog.IsQFlaggedCompleted(60049) == false) then
		APR.ProgressShown = 1
...
function APR.FP.GetMeToNextZoneSpecialRe(APRt_Zone)
	if (APRLumberCheck == 0 and C_QLog.IsQFlaggedCompleted(35049)) then
	...
	if (APRLumberCheck == 0 and C_QLog.IsQFlaggedCompleted(34992)) then
	...
	if (((Map == 1409 or Map == 1726) or C_QLog.IsQFlaggedCompleted(55992) or C_QLog.IsQFlaggedCompleted(55991) or C_QLog.IsQFlaggedCompleted(59984) or C_QLog.IsQFlaggedCompleted(59985)) and APR.Level < 15) then
		if (C_QLog.IsOnQ(59583) == true) then
			C_QLog.SetSelectedQ(59583)
			C_QLog.SetAbandonQ()
			C_QLog.AbandonQ()
		end
		if (C_QLog.IsOnQ(60343) == true) then
			C_QLog.SetSelectedQ(60343)
			C_QLog.SetAbandonQ()
			C_QLog.AbandonQ()
		end
