...
APR.Portals.Coords = {
    ["Alliance"] = {
        ...
        [13] = {
            ...
            ["DalaranLichKing"] = { x = 952.7, y = -9022.8 },
            ["JadeForestMoP"] = { x = 929.5, y = -9004.8 },
            ["StormshieldWoD"] = { x = 887.7, y = -9060.3 },
            ["AzsunaLegion"] = { x = 909.6, y = -9077.8 },
            ["BoralusBFA"] = { x = 889.4, y = -9081.2 },
    ...
    ["Horde"] = {
        [12] = {
            ...
            ["AzsunaLegion"] = { x = -4530.4, y = 1448.7 },
