...
L = {
	...
	["AUTO_PICK_REWARD_ITEM"] = "任务升级自动挑选任务奖励",
	["AUTO_REPAIR"] = "自动修理",
	--[[Translation missing --]]
	["AUTO_SELECTION_OF_DIALOG"] = "Auto-selection of dialog",
	["AUTO_VENDOR"] = "自动摧毁灰色物品",
	--[[Translation missing --]]
	...
	--[[Translation missing --]]
	["LISTEN"] = "Listen",
	["LOA_INFO_1"] = "——贡克：图腾，40%秒移动",
	["LOA_INFO_2"] = "——Paku：Wrav骑师，飞定义的地方",
	--[[Translation missing --]]
	["LOAD"] = "Load",
	--[[Translation missing --]]
	["LOADED"] = "Loaded",
