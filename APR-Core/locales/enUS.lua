...
app.L = {
    ...
    QUESTLIST_SCALE = "QuestList Scale",
    QUESTORDERLIST_SCALE = "Quest Order List Scale",
    SHOW_QUESTORDERLIST = "Show Quest Order List",
    RESET_QUESTORDERLIST  = "Reset QuestOrderList",
    ...
    DETACH_QUEST_ITEM_BTN = "Detatch Quest Item Buttons",
    QUEST_BTN_SCALE = "Quest Buttons Scale",
    CLOSE = "Close",
    ...
    CLICK_ON_NPC = "Click on the the npc (Zen'Kiki) so he pulls Hawks",


    SAIL_TO = "Sail to",
    TALK_TO = "Talk to",
    GO_PORTAL_ROOM = "Go to Portal Room",
    CLOSEST_FP = "Closest fly point",
