...
-- SETTINGS
L.ACCEPT_QUEST = "퀘스트 수락";
L.DECLINE_QUEST = "거절 퀘스트";
L.SETTINGS = "설정";
L.SKIPPED_CUTSCENE = "스킵 컷씬";
...
-- Extra Quest text
L.GET_FLIGHT_POINT = "비행 경로 발견";
L.OPTIONAL = "선택";
L.SET_HEARTHSTONE = "귀환석 설정";
L.SUGGESTED_PLAYERS = "추천 플레이어";
L.TRAVEL_TO = "여행";
L.TURN_IN_QUEST = "퀘스트 제출";
L.USE_BOAT = "배를 타고";
L.USE_FLIGHTPATH = "날아서";
L.USE_HEARTHSTONE = "귀환석 사용";
L.USE_ITEM = "아이템 사용";
