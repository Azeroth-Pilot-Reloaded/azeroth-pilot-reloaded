...
L.ACCEPT_QUEST = "Acceptez la qu\195\170te";
L.DECLINE_QUEST = "Décliner la quête";
L.USE_BOAT = "Prenez le bateau pour";
L.BUY_ITEM = "Achetez l'objet";
L.COMPLETE_QUEST = "Terminez la qu\195\170te";
