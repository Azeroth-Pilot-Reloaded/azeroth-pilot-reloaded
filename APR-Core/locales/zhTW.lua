...
L = {
	...
	["AUTO_PICK_REWARD_ITEM"] = [=[依照裝備等級升級自動選取任務獎勵
]=],
	["AUTO_REPAIR"] = "自動修理",
	--[[Translation missing --]]
	["AUTO_SELECTION_OF_DIALOG"] = "Auto-selection of dialog",
	["AUTO_VENDOR"] = "自動販賣灰色物品",
	--[[Translation missing --]]
	...
	--[[Translation missing --]]
	["LISTEN"] = "Listen",
	["LOA_INFO_1"] = "Gonk圖騰，增加移動速度40%維持30秒",
	["LOA_INFO_2"] = "Pa'ku Waverider，飛往定點",
	--[[Translation missing --]]
	["LOAD"] = "Load",
	--[[Translation missing --]]
	["LOADED"] = "Loaded",
	["LOCK_ARROW_WINDOW"] = "鎖定箭頭視窗",
	["LOCK_QLIST_WINDOW"] = "鎖定任務表單視窗",
	--[[Translation missing --]]
	["LOOT_BAG"] = "Loot bag",
	--[[Translation missing --]]
