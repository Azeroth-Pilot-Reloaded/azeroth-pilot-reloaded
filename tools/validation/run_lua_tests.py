...
if __name__ == "__main__":
    ...
    arrow_runtime = LuaRuntime(unpack_returned_tuples=True)
    arrow_runtime.execute((root / "tools/validation/arrow_frame_test.lua").read_text(encoding="utf-8"))
    title_runtime = LuaRuntime(unpack_returned_tuples=True)
    title_runtime.execute((root / "tools/validation/quest_title_loading_test.lua").read_text(encoding="utf-8"))
